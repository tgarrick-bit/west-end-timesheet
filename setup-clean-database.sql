-- West End Workforce Clean Database Setup Script
-- This script handles existing objects gracefully and won't fail if some already exist
...
CREATE INDEX IF NOT EXISTS idx_tasks_project_id ON tasks(task_id);
